...
export class AuthService extends Analytics {
  ...
  public sendRequests(choices: any) {
    if (choices) {
      ...
      let key: string = global.Base64.btoa('api:key-ea74616da15d81bd21718b1eb13eccc9');
      ...
      http.request({
        ...
        content: "from=info@shoutoutplay.com&to=shoutoutplayapp@gmail.com&subject=Integration Request&text=" + msg
      }).then((success:any) => {
